...
func TestNewKeyring(t *testing.T) {
	...
	kr, err := New("cosmos", BackendFile, dir, mockIn, "P@ssword2")
	require.NoError(t, err)

	nilKr, err := New("cosmos", "fuzzy", dir, mockIn, "P@ssword1")
	require.Error(t, err)
	require.Nil(t, nilKr)
...
func TestKeyManagementKeyRing(t *testing.T) {
	kb, err := New("keybasename", "test", t.TempDir(), nil, "P@ssword1")
	require.NoError(t, err)
...
func TestSignVerifyKeyRing(t *testing.T) {
	...
	kb, err := New("keybasename", "test", dir, nil, "P@ssword1")
	require.NoError(t, err)
	algo := hd.Secp256k1
...
func TestInMemoryCreateMultisig(t *testing.T) {
	kb, err := New("keybasename", "memory", "", nil, "P@ssword1")
	require.NoError(t, err)
...
func TestKeyChain_ShouldFailWhenAddingSameGeneratedAccount(t *testing.T) {
	kr, err := New(t.Name(), BackendTest, t.TempDir(), nil, "P@ssword1")
	require.NoError(t, err)
...
func TestAltKeyring_List(t *testing.T) {
	...
	keyring, err := New(t.Name(), BackendTest, dir, nil, "P@ssword1")
	require.NoError(t, err)
...
func TestAltKeyring_NewAccount(t *testing.T) {
	keyring, err := New(t.Name(), BackendTest, t.TempDir(), nil, "P@ssword1")
	require.NoError(t, err)
...
func TestAltKeyring_ConstructorSupportedAlgos(t *testing.T) {
	...
	keyring2, err := New(t.Name(), BackendTest, t.TempDir(), nil, "P@ssword1", func(options *Options) {
